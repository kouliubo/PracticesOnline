...
public class UserCookies {
    ...
    private UserCookies() {
        ...
        spOption = AppUtils.getContext().getSharedPreferences("sp_option", Context.MODE_PRIVATE);
    }
    ...
    public void changeOpionState(Option option, boolean isChecked, boolean isMulti) {
    ...
    public boolean idOptionSelected(Option option) {
        String ids = spOption.getString(option.getQuestionId().toString(), "");
